...
class CredenciamentoEmail
{
    ...
    public function __construct($attributes = array())
    {
        ...
        $this->tituloEmail = 'Referente ao Atendimeno da OS - Credenciamento';
    }
    ...
    public function getCorpoEmail()
    {
        ...
        $corpoEmail = \str_replace('{{descricaoGestor}}', $this->attributes['descricao'], $corpoEmail);
    ...
    public function enviaEmail($empresaEmail, $empresaNome, $emailsCopia, $anexos)
    {
        ...
        $configuracoes['TITULO_EMAIL'] = 'Medb | Credenciamento';
