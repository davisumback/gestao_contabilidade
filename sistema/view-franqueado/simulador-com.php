...
<?php if(!empty($intervalo)) : ?>
	...
	<form class="needs-validation-loading" action="../controllers/simulador/simula-com.php" method="post" id="simulador-form" autocomplete="off" novalidate>
        <div class="col-md-12 text-center mb-3">
        	<button type="submit" class="btn btn-padrao btn-cor-accent-primaria font-weight-bold">Simular</button>
            <button type="button" onclick="vaiParaNovaPagina('form-simulador-com.php')" class="btn btn-padrao btn-cor-accent-secundaria font-weight-bold">Voltar</button>
        </div>
		...
		<?php foreach ($intervalo as $array_data => $data) : ?>
			...
			<div class="col-md-4">
	            <div class="card simulador-card">
	                <div class="card-header bg-cor-primaria">
	                ...
	                <div class="card-body">
	                    <div class="mx-auto d-block">
							...
							<h6 class="text-sm-left text-dark-blue mt-2 mb-1">Faturamento</h6>
							<input class="form-control" type="text" id="<?='fat-'.$data[1]?>" name="<?='fat-'.$data[1]?>" onfocus="projeta(<?=$id?>)" required="true">
                            <div class="invalid-feedback">
        						Obrigatório*
        					</div>

							<h6 class="text-sm-left mt-2 mb-1 text-dark-blue">Pró-labore</h6>
