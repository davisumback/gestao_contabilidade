...
<div class="row">
    <div class="col-md-4">
        <aside class="profile-nav alt">
            <section class="card">
                <div class="card-header user-header alt bg-cor-primaria">
                    <div class="media">
    ...
    <div class="col-md-4 text-center">
        <div class="col-6 text-right">
            <form class="needs-validation-loading" action="form-altera-simulador.php" method="post">
                <button type="submit" class="btn btn-cor-accent-primaria btn-padrao">Alterar</button>
            </form>
        </div>
        <div class="col-6 text-left">
            <button type="button" class="btn btn-cor-primaria btn-padrao" data-toggle="modal" data-target="#salvar-empresa">Salvar</button>
        </div>
    </div>
</div>
