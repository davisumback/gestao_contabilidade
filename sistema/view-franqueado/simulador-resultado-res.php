...
$menu_topo->setTituloNavegacao("Simulador | Resultado Resumido =)");
...
<div class="col-md-12">
    <div class="feed-box">
        <section class="card border-cor-primaria rounded">
            <div class="card-body">
    ...
    <div class="feed-box">
        <section class="card rounded">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <h5 class="text-center text-dark-blue mb-4"><strong>Mês
                                <?=$i+1?></strong></h5>
