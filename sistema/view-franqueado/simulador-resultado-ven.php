...
<div class="col-md-12">
    ...
    <div class="feed-box">
        ...
        <section class="card rounded">
            <div class="card-body">
                <h5 class="text-center text-dark-blue mb-4"><strong>Comparativo</strong></h5>
                    ...
                    <table class="table">
                        <thead>
                            <tr class="text-dark-blue">
                                ...
                                <th scope="col" class="border-bottom-0">Anexo 3 Antecipado</th>
                                <th scope="col" class="border-bottom-0">Anexo 3</th>
                                <th scope="col" class="border-bottom-0">Anexo 5</th>
                                <th scope="col" class="border-bottom-0">Presumido</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Total Tributação</th>
                                <td class="border-top-0">
                                    <h6 class="badge badge-comparativo badge-anexo3" id="t-tributacao-anexo3"></h6>
                                </td>
                                <td class="border-top-0">
                                    <h6 class="badge badge-comparativo badge-anexo3">
                                        R$ <?=Helpers::formataMoedaView(array_sum($anexo3_sem_antecipacao))?>
                                    </h6>
                                </td>
                                <td class="border-top-0">
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Total IRRF</th>
                                <td class="border-top-0">
                                    <h6 class="badge badge-comparativo badge-anexo3" id="t-irrf-anexo3"></h6>
                                </td>
                                <td class="border-top-0">
                                    <h6 class="badge badge-comparativo badge-anexo3">
                                        R$ <?=Helpers::formataMoedaView(array_sum($irrf_sem_antecipacao))?>
                                    </h6>
                                </td>
                                <td class="border-top-0">
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Total INSS</th>
                                <td class="border-top-0">
                                ...
                                <td class="border-top-0">
                                    <h6 class="badge badge badge-comparativo badge-anexo3">
                                        R$ <?=Helpers::formataMoedaView(array_sum($inss_sem_antecipacao))?>
                                    </h6>
                                </td>
                                <td class="border-top-0">
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Total Geral</th>
                                <td class="border-top-0">
                                ...
                                <td class="border-top-0">
                                    <h6 class="badge badge-comparativo badge-presumido" id="t-geral-presumido">R$ </h6>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <div class="feed-box">
        <section class="card rounded">
            <div class="card-body">
                ...
                <h5 class="text-center text-dark-blue mb-4"><strong>Mês <?=$i+1?></strong></h5>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Tributo</th>
                                <td class="border-top-0">
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">IRRF</th>
                                <td class="border-top-0">
                                    <h6 class="badge badge-valor-m badge-anexo3">
                                        R$
                                        <?php
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">INSS</th>
                                <td class="border-top-0">
                                    <h6 class="badge badge-valor-m badge-anexo3">
                                        R$
                                        <?php
                            ...
                            <tr>
                                <th scope="row" class="text-dark-blue border-top-0">Total</th>
                                <td class="border-top-0">
                                    <h6 class="badge badge-valor-m badge-anexo3">R$
                                        <?=Helpers::formataMoedaView($total_tributos_anexo3)?>
                                    </h6>
                                </td>
                                <td class="border-top-0">
                                    <h6 class="badge badge-valor-m badge-anexo5">R$
                                        <?=Helpers::formataMoedaView($total_tributos_anexo5)?>
                                    </h6>
                                </td>
                                <td class="border-top-0">
                                    <h6 class="badge badge-valor-m badge-presumido">R$
                                        <?=Helpers::formataMoedaView($total_tributos_presumido)?>
                                    </h6>
                                </td>
                            </tr>
                        </tbody>
