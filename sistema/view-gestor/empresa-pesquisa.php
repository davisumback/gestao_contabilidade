...
<div class="container-fluid">
    <div class="text-center mb-2">
        <?= Mensagem::getMensagem($_COOKIE, 'inativaEmpresa', 'mensagemInativaEmpresa'); ?>
    </div>
    ...
    <form id="form" action="../controllers/empresa/pesquisa-empresa.php" method="post" autocomplete="off" novalidate>
