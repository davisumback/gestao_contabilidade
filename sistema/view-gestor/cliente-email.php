                    ...
                    <tbody class="texto-table">
                        <?php foreach ($clientes as $cliente) : ?>
                            <tr>
                                ...
                                <td><?=$cliente['sexo']?></td>
                                <td>
                                    <button data-id-cliente="<?=$cliente['clientesId']?>" data-toggle="modal" data-target="#inserePis" class="btn btn-success btn-sm btn-padrao font-weight-bold">Cadastrar</button>
                                </td>
                            </tr>
                        <?php endforeach ?>                        
                    </tbody>
