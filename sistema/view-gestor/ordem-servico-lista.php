    ...
    <div class="row">
        <?php foreach ($ordensDeServicos as $os) : ?>
            ...
            <div class="col-md-4 col-sm-12 text-center">
                <div id="cardClick" class="card bg-light mb-3 border-<?=$cor?> rounded" style="cursor:pointer;"
                    ...
                    <div class="card-body">
                        ...
                        <?php else : ?>
                            ...
                            <h6 id="cnpjClick" onclick="noClick()" class="card-title">CNPJ: <?=$os['cnpj']?></h6>
                        <?php endif ?>
