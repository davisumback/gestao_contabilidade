...
$menu_topo->setTituloNavegacao("Cadastrar PIS :)");
require_once('menu-left.php');
require_once('../cabecalho.php');

$dao = new ClienteDAO();
$clientes = $dao->getAllClienteSemPis();
?>

<div class="container-fluid">
    <?=Mensagem::getMensagem($_COOKIE, 'insercaoPis', 'mesangemInsercaoPis');?>

    <div class="card">
        <div class="card-header bg-success text-white text-center font-weight-bold">
            Área para cadastro do PIS dos clientes
        </div>
        <div class="card-body">
                    ...
                    <tbody class="texto-table">
                        <?php foreach ($clientes as $cliente) : ?>
                            <tr>
                                ...
                                <td><button data-id-cliente="<?=$cliente['clientesId']?>" data-toggle="modal" data-target="#inserePis" class="btn btn-success btn-padrao btn-sm font-weight-bold">Cadastrar</button></td>
                            </tr>
                        <?php endforeach ?>                
                    </tbody>
                </table>
...
<?php include __DIR__ . '/../modal/cliente/insere-pis.php'; ?>
