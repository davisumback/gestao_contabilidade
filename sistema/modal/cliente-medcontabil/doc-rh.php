<div class="modal fade" id="modalDocRh" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form action="../controllers/navegador-arquivos/upload-arquivos-teste.php?method=store" class="needs-validation" method="post" enctype="multipart/form-data" autocomplete="off" novalidate>
            <div class="modal-body">
               <div class="row">
                  <input name="tipo" id="doc-conta" value="upload-rh" type="text" hidden>                     
                  ...
                  <div class="col-md-11 autocomplete">
                     ...
                     <div class="input-group mb-3">
                        <div class="custom-file">
                           <input onchange='$("#fileLabelRh").html($(this).val());' type="file" class="custom-file-input" name="fileUpload" required>
                           <label id="fileLabelRh" class="custom-file-label procurar-arquivo" for="edital">Escolha um arquivo</label>
                        </div>
                     </div>  
                  </div>  
               </div>
