<div class="modal fade" id="insere-nova-conta-bancaria" tabindex="-1" role="dialog" aria-labelledby="insere-conta-bancaria" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-cor-primaria">
                <h5 class="modal-title text-white">Cadastrar Conta Bancária Adicional</h5>
            ...
            <form action="../controllers/empresa/conta-bancaria.php" method="post" class="needs-validation-loading" novalidate autocomplete="off">
                ...
                <input name="method" value="storeNovaConta" hidden>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-4">
                            ...
                            <input name="agencia" type="text" class="form-control" required maxlength="5">
                            <div class="invalid-feedback">
                                Obrigatório *
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button class="btn btn-success btn-padrao font-weight-bold" type="submit"><strong>Salvar</strong></button>
                </div>
            </form>
        </div>
    </div>
