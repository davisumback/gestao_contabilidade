<div class="modal fade" id="insere-cnae" tabindex="-1" role="dialog" aria-labelledby="insere-conta-bancaria" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-green">
                <h5 class="modal-title text-white">Cadastrar CNAE</h5>
            ...
            <form action="../controllers/empresa/cnae.php" method="post" class="needs-validation-loading" novalidate autocomplete="off">
                ...
                <input id='principal' name="principal" value="SIM" hidden>
