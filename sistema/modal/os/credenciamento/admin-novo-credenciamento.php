    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="needs-validation-loading" action="../controllers/ordem-servico/admin.php" method="post" autocomplete="off" novalidate enctype="multipart/form-data">
                <input name="method" value="storeOsCredenciamento" hidden>
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group text-center">
                                ...
                                <input required class="form-control col-md-4 col-sm-6 mx-auto text-center" type="text" name="empresasId" autocomplete="off" maxlength="4">
