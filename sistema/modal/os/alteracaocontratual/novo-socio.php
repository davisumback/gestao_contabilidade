<div class="modal fade bd-example-modal-lg" id="modalNovoSocio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-cor-primaria">
                <h5 class="modal-title" id="exampleModalLongTitle">Novo Sócio</h5>
            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label procurar-arquivo" for="inputGroupFile02">Selecionar arquivo</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label procurar-arquivo" for="inputGroupFile03">Selecionar arquivo</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-5">
                            ...
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label procurar-arquivo" for="inputGroupFile04">Selecionar arquivo</label>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="col-md-6 my-1">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control col-3" id="porcentagem-socio"
