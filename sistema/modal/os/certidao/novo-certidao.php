    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation-loading" method="post" action="../controllers/ordem-servico/admin.php?method=storeOsCertidaoMedcontabil" novalidate autocomplete="none">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="form-group text-center">
                                ...
                                <input hidden value="<?=$empresasId?>" required class="form-control col-md-3 col-sm-6 mx-auto text-center" type="text" name="empresasId" autocomplete="none" maxlength="4">
