...
$cliente = new Cliente(
    $cpf, $_POST['nome'], $_POST['situacao_cadastral'], $_POST['email'], $_POST['data_nascimento'], $_POST['crm'], $_POST['ies_id'],
...
if($retorno['resultado'] == false){
    ...
    $cpf_hash = md5($cpf);
    $link_aceite = 'http://www.grupobmw.com.br/medb/sistema/email-view/aceitou.php?resultado='.$cpf_hash.'&unassigned='.$retorno['id_cliente'];
    $link_rejeite = 'http://www.grupobmw.com.br/medb/sistema/email-view/rejeitou.php?resultado='.$cpf_hash.'&unassigned='.$retorno['id_cliente'];
