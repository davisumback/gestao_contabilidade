...
$menu_topo->setTituloNavegacao("Cadastrar Acesso :)");
require_once('menu-left.php');
require_once('../cabecalho.php');

$acesso = new \App\Model\Empresa\Acesso();
$empresas = $acesso->empresasSemAcesso();
?>
                    ...
                    <tbody class="texto-table">
                        <?php foreach ($empresas as $empresa) : ?>
                            <tr>
                                ...
                                <td>
                                    <button data-id-empresa="<?=$empresa['id']?>" data-toggle="modal" data-target="#insereAcesso" class="btn btn-success btn-sm btn-edita-usuario font-weight-bold">Cadastrar</button>
                                </td>
                            </tr>
                        <?php endforeach ?>                        
                    </tbody>
...
<?php include __DIR__ . '/../modal/empresa/acesso/insere.php'; ?>
