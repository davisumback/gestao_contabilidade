                        ...
                        <div class="card-body texto-padrao p-2">
                            <form class="needs-validation-loading" action="nota-fiscal.php" method="get" novalidate autocomplete="none">
                                ...
                                <div class="row justify-content-center mt-3">
                                    <div class="col-md-5">
                                        <button class="btn btn-padrao btn-sm btn-cor-primaria font-weight-bold" type="submit">
                                            Buscar
                                        </button>
                                    </div>
                                </div>                        
                    ...
                    <div class="card-body">
                        <form action="nota-fiscal.php" class="needs-validation-loading" novalidate>
                            <div class="form-group text-center">
                                ...
                                <input name="empresasId" type="text" class="text-center mx-auto form-control col-5" maxlength="4" required autocomplete="off">
                                <div class="invalid-feedback">Obrigatório *</div>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-padrao btn-success font-weight-bold">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
