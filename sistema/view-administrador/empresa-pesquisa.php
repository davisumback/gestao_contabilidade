...
<div class="container-fluid">
    ...
    <form id="form" class="needs-validation-loading" action="../controllers/empresa/pesquisa-empresa.php" method="post" autocomplete="off" novalidate>
        ...
        <div class="row text-center">
            <div class="col-md-4 mx-auto mb-3 label-cadastro">
                <button type="submit" class="btn btn-padrao btn-info font-weight-bold">Pesquisar</button>
                <a class="btn btn-success btn-padrao font-weight-bold" href="empresa-pesquisa.php?todasEmpresas=1">Pesquisar Todas</a>
            </div>
        </div>
    </form>
