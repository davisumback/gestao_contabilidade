                ...
                <table id="myTable" class="table table-bordered table-hover">
                    <thead class="label-cadastro">                   
                        <tr class="table-success">
                            ...
                            <th scope="col">UF</th>
                            <th scope="col">IES</th>
                            <th scope="col" class="text-nowrap">Ano Formação</th>
                            <th scope="col">Especialidade</th>
                            <th scope="col" class="text-nowrap">Conclusão Residência</th>
                            <th scope="col" class="text-nowrap">Medb Representa</th>
                    ...
                    <tbody class="label-cadastro">
                        <?php foreach ($dados as $dado) : ?>
                            <tr>
                                ...
                                <td class="text-nowrap"><?=Helpers::mask($dado['cpf'], '###.###.###-##')?></td>
                                <td><?=$dado['crm']?></td>
                                <td><?=$dado['estado']?></td>
