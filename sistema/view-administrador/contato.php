    ...
    <?php else : ?>
        ...
        <div class="card">
            <div class="card-header bg-success text-white text-center font-weight-bold">
                Área para edição de todos os contatos do nosso sistema
            </div>
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <table class="table">
                        ...
                        <tbody class="texto-table">
                            <?php foreach ($contatos as $contato) : ?>
                                <tr>
                                    <td class="font-weight-bold"><?=$contato['nome']?></td>
                                    <td class="font-weight-bold"><?=$contato['email']?></td>
                                    <td class="text-nowrap font-weight-bold"><?=\App\Helper\Helpers::mask($contato['telefone'], '(##) #####-####');?></td>                            
                                    <td class="text-center text-nowrap font-weight-bold">
                                        <button                                        
                                            data-toggle="modal"
