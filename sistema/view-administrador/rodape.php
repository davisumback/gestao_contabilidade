...
// $rodape->setScript('https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css');

$rodape->setScript('../assets/js/main.js');
$rodape->setScript('../assets/custom-js/loading-automatico.js');
$rodape->setScript('../assets/custom-js/arruma-navbar-bug.js');
$rodape->setScript('../assets/custom-js/cidades-estados.js');
// $rodape->setScript('../assets/js/lib/data-table/datatables.min.js');    
// $rodape->setScript('../assets/js/lib/data-table/dataTables.bootstrap.min.js');
// $rodape->setScript('../assets/js/lib/data-table/dataTables.buttons.min.js');    
// $rodape->setScript('../assets/js/lib/data-table/datatables-init.js');    
