...
if(array_key_exists('hoje', $_GET) && $_GET['hoje'] == '1'){
    ...
    $nota_array = $nota_dao->getTodasNotas();
            ...
            <?php foreach ($nota_array as $nota) : ?>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card text-light card-anotacao <?=$cor_nota?>" >
                        <div class="card-body">
                            <h6 class="text-light">Usuário: <span style="color:#9E9E9E;font-weight:bold;"><?=$nota['usuario']?><span></h6>
                        ...
                        <div class="text-center mb-2">
                            <button
                                ...
                                type="button"
                                class="btn btn-secondary btn-sm btn-edita-usuario">
                                    Editar
                            </button>
                            <button
                                data-toggle="modal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title label-cadastro">Editar Anotação</h5>
