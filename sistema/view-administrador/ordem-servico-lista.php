                ...
                <div class="col-md-3 col-sm-12 mx-auto">
                    <div class="form-group text-center">
                        ...
                        <select class="form-control" name="method" id="method" required>                            
                            <option value="getAll" <?=($_REQUEST['method'] == 'getAll') ? 'selected' : ''?>>Todas</option>
                            <option value="getAllEmitidas" <?=($_REQUEST['method'] == 'getAllEmitidas') ? 'selected' : ''?>>Emitidas</option>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <?php if ($_GET['method'] == 'getAllEmitidas') : ?>
                    <button type="button" class="btn btn-padrao btn-success font-weight-bold mb-3" data-toggle="modal" data-target="#osTipo<?=$_GET['tipoOs']?>">
                        Nova O.S
                    </button>
                <?php endif ?>                
                <form class="needs-validation-loading d-inline-block" action="ordem-servico-lista.php?method=getAllEmitidas&tipoOs=3">
                    ...
                    <button type="submit" class="btn btn-padrao btn-success font-weight-bold mb-3">
