                    ...
                    <tbody class="label-cadastro">
                        <?php foreach ($prospects as $prospect) : ?>
                            <tr style="cursor:pointer;" >
                                ...
                                <td class="text-nowrap" onclick="vaiParaNovaPagina('proposta-comercial.php?prospect=<?=$prospect['id']?>')"><?=Helpers::mask($prospect['telefone'], '(##) #####-####')?></td>
                                ...
                                <td onclick="vaiParaNovaPagina('proposta-comercial.php?prospect=<?=$prospect['id']?>')"><?=Helpers::formataDataCompetenciaView($prospect['ano_formacao'], '##/####')?></td>
                                <td onclick="vaiParaNovaPagina('proposta-comercial.php?prospect=<?=$prospect['id']?>')"><?=$prospect['especialidade']?></td>
                                <td onclick="vaiParaNovaPagina('proposta-comercial.php?prospect=<?=$prospect['id']?>')"><?=$prospect['sexo']?></td>
                                <td class="text-nowrap" style="cursor:auto">
                                    <button type="button" class="btn btn-padrao btn-warning btn-sm font-weight-bold"
                                        data-toggle="modal"
