...
<div class="container-fluid pb-3" id="conteudo">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-12 text-right">
                                <button data-toggle="modal" data-target="#congela-empresa" type="button" class="btn btn-padrao btn-sm <?=($isEmpresaCongelada) ? 'btn-success' : 'btn-secondary'?>">
                        ...
                        <div class="row">
                            <div class="col-12 mt-2 text-right">
                                <button data-toggle="modal" data-target="#cadastra-acesso" type="button" class="btn btn-padrao btn-info btn-sm">Novo Acesso</button>
                            </div>                        
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-secondary">Congelamento</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <h5 class="text text-secondary mb-2">Tem certeza que deseja <?=($isEmpresaCongelada) ? 'descongelar' : 'congelar'?> a empresa</h5>
                <h5 class="text label-cadastro"><?=$_SESSION['viewIdEmpresa'] . ' | ' . $_SESSION['viewNomeEmpresa']?> <span class="text text-secondary">?</span> </h5>
                ...
                <div class="mt-2 text-center">
                    <form class="needs-validation" action="../controllers/empresa/congela-empresa.php" method="post" novalidate autocomplete="off">
                        ...
                        <div class="text-right mt-3">
                            <button type="submit" id="confirma-congelamento" class="btn btn-padrao <?=($isEmpresaCongelada) ? 'btn-success' : 'btn-secondary'?>">
                                <?=($isEmpresaCongelada) ? 'Descongelar' : 'Congelar'?>
                            </button>
                        </div>
                    </form>
...
<div class="modal fade" id="cadastra-acesso" tabindex="-1" role="dialog" aria-labelledby="cadastra-acesso" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="text text-secondary mb-4">Aqui você cadastra o login e senha de acesso da Empresa no(s) site(s) da(s) Prefeitura(s).</h6>
