...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header bg-cor-accent-primaria text-center">
            <i class="fas fa-user h5"></i><strong class="card-title pl-md-2 h5">Cadastro de um novo cliente</strong>
        </div>
        <div class="card-body">
            <form class="needs-validation-loading" action="../controllers/cliente/insere-cliente.php" method="post" autocomplete="off" novalidate>
                ...
                <div class="row mb-3">
                    <div class="col-md-3 label-cadastro">
                        ...
                        <input value="" name="nome" type="text" class="form-control" id="nome" autocomplete="none" required>
                        <div class="invalid-feedback">
                            Digite um nome válido.
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="data_nascimento" type="date" class="form-control" id="nascimento" placeholder="" min="1930-01-01" required>
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col-md-3 label-cadastro">
                        ...
                        <input name="email" type="text" class="form-control" id="email" maxlength="50" autocomplete="none">
                    </div>
                    <div class="col-md-2 label-cadastro">
                        <label for="telefone-celular">Telefone Celular *</label>
                        <input name="telefone_celular" type="text" class="form-control" id="telefone-celular" autocomplete="none" placeholder="" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="telefone_comercial" type="text" class="form-control" id="telefone-comercial" autocomplete="none">
                        <div class="invalid-feedback">
                ...
                <div class="row mb-3">
                    <div class="col-md-2 label-cadastro">
                        ...
                        <select name="estado_civil" class="custom-select d-block w-100" id="estado-civil" required>
                            <option value="">Escolha...</option>
                    ...
                    <div class="col-md-3 label-cadastro">
                        ...
                        <select name="regime_casamento" class="custom-select d-block w-100" id="regime-casamento">
                            <option value="">Escolha...</option>
                ...
                <div class="row mb-4">
                    <div class="col-md-3 label-cadastro" type="text">
                        ...
                        <select name="ies_id" class="custom-select d-block w-100" id="faculdade">
                            <option value="">Escolha...</option>
                    ...
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="crm" type="text" class="form-control" id="crm" maxlength="20">
                    </div>
                    <div class="col-md-2 label-cadastro">
                        <label for="profissao">Profissão *</label>
                        <select name="profissao" class="custom-select d-block w-100" id="profissao" required>
                            <option value="">Escolha...</option>
                    ...
                    <div class="col-md-4 label-cadastro" id="div-outra-profissao">
                    </div>
                </div>
                ...
                <div class="row mb-3 mt-4">
                    <div class="col-md-2 label-cadastro">
                        ...
                        <select name="tipo_documento" class="custom-select d-block w-100" id="tipo-documento" required>
                            <option value="">Escolha...</option>
                    ...
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="numero_documento" type="text" class="form-control" id="numero-documento" maxlength="50" required autocomplete="none">
                        <div class="invalid-feedback">
                            Obrigatório *
                        </div>
                    </div>
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="data_emissao" type="date" class="form-control" id="data-emissao" required autocomplete="none">
                        <div class="invalid-feedback">
                            Obrigatório *
                        </div>
                    </div>
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input name="documento_validade" type="date" class="form-control" id="documento-validade" autocomplete="none">
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-2 label-cadastro" type="text">
                    ...
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input value="SSP" name="documento_orgao" type="text" class="form-control" id="documento-orgao" autocomplete="none" maxlength="70" required>
                        <div class="invalid-feedback">
                            Obrigatório *
                        </div>
                    </div>
                    <div class="col-md-2 label-cadastro">
                        ...
                        <input value="Brasileiro" name="documento_naturalidade" type="text" class="form-control" id="documento-naturalidade" autocomplete="none" maxlength="50" required>
                        <div class="invalid-feedback">
                            Obrigatório *
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-1">
                        ...
                        <input name="numero-endereco" type="text" class="form-control" id="numero-endereco" maxlength="10" required>
                        <div class="invalid-feedback">
                            Obrigatório *
                        </div>
                    </div>
