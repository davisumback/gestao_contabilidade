    ...
    <form id="form" class="needs-validation-loading" action="../controllers/empresa/insere-guia.php" enctype="multipart/form-data" method="post" autocomplete="off" novalidate >
        ...
        <div class="row mt-3" id="div-guias">
            <div class="col-2 label-cadastro">
                <div class="custom-control custom-checkbox" hidden>
                    <input value="on" name="guias[HONORARIOS]" class="custom-control-input" id="HONORARIOS">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3 mb-3">
            <div id="div-vencimento" class="col-md-6 label-cadastro">
                ...
                <input value="20/06/2019" placeholder="DD/MM/AAAA" id="input-vencimento" class="form-control col-6" type="text" name="data_vencimento" required>
                <div class="invalid-feedback">
                    Escolha uma data*
                </div>
            </div>
            ...
            <div class="col-md-6 label-cadastro">
                ...
                <input readonly value="<?=$dataCompetenciaView?>" placeholder="MM/AAAA" id="data-competencia" class="form-control col-6" type="text" name="data_competencia" required>
                <div class="invalid-feedback">
                    Escolha uma data*
                </div>
            </div>
