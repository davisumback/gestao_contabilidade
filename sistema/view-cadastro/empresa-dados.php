                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-right">
                                <button data-toggle="modal" data-target="#congela-empresa" type="button" class="btn font-weight-bold btn-padrao btn-sm <?=($isEmpresaCongelada) ? 'btn-success' : 'btn-secondary'?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">Congelamento</h5>
...
<div class="modal fade" id="cadastra-acesso" tabindex="-1" role="dialog" aria-labelledby="cadastra-acesso" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">Cadastro de Acessos</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
