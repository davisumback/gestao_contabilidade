                            ...
                            <tbody>
                                <tr class="">
                                    <td class="border-left-0 border-bottom-0">
                                        <button type="button" class="btn btn-info btn-padrao font-weight-bold mt-2" data-toggle="modal" data-target="#controle">999</button>
                                        <button type="button" class="btn btn-info btn-padrao font-weight-bold mt-2" data-toggle="modal" data-target="#controle">999</button>
                                        <button type="button" class="btn btn-info btn-padrao font-weight-bold mt-2" data-toggle="modal" data-target="#controle">999</button>
                                        <button type="button" class="btn btn-info btn-padrao font-weight-bold mt-2" data-toggle="modal" data-target="#controle">999</button>
                                        <button type="button" class="btn btn-info btn-padrao font-weight-bold mt-2" data-toggle="modal" data-target="#controle">999</button>
...
<?php include __DIR__ . '/../modal/contrato/controle.php'; ?>
