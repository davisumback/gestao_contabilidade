                ...
                <tbody class="label-cadastro <?= $corStatusGuias ?>">
                    ...
                    <?php foreach ($empresas as $empresa) : ?>
                        ...
                        <tr style="cursor:pointer" onclick="vaiParaNovaPagina('<?= $caminho ?>')">
                            ...
                            <td class="<?= ($empresa['updatedAt'] == null) ? 'text-success' : 'text-danger' ?>">
                                <?= ($empresa['regime_tributario'] == 'Presumido') ? 'Presumido' : $empresa['prolaboreAnterior'] ?></td>
                            <td class="text-success">
                                <?= ($empresa['regime_tributario'] == 'Presumido') ? 'Presumido' : $empresa['prolabore'] ?>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
