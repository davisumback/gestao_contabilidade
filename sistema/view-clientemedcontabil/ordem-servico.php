        ...
        <div class="col-md-7 col-sm-12">
            <div class="card text-center border-<?=$cor?> rounded">
                <div class="card-header bg-<?=$cor?>">
                    <strong class="<?=($os[0]['status'] == 'PENDENTE') ? 'text-dark' : 'text-white'?>">O.S nº <?=$_GET['os']?> - <?=$os[0]['status']?></strong>
                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            <?php if ($_GET['situation'] == 'getAllRecebidas' && $os[0]['status'] == 'PENDENTE') : ?>
                                <button type="button" data-toggle="modal" data-target="#atender-<?=strtolower($os[0]['nomeArquivo'])?>" class="btn btn-padrao btn-success btn-primary font-weight-bold">Atender</button>
                            <?php endif ?>
                        </div>
                    </div>
                </div>
