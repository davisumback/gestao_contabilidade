...
$empresasGuias = $guiaDao->getTodasGuiasMesCompetenciaSemMovimentacao('Presumido', 'MEDB', $quantidadeGuiasPresumido);
...
// $empresasGuias = $guiaDao->getEmpresasAptasSemFgts('Presumido', 'MEDB', $quantidadeGuiasPresumido);
...
$empresasGuias = $guiaDao->getTodasGuiasMesCompetencia('Presumido', 'MEDB', $quantidadeGuiasPresumido);
