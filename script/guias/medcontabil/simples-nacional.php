...
$empresasGuias = $guiaDao->getTodasGuiasMesCompetenciaSemMovimentacao('SN', 'MEDCONTABIL', $quantidadeGuiasSimplesNacional);
...
$empresasGuias = $guiaDao->getTodasGuiasMesCompetencia('SN', 'MEDCONTABIL', $quantidadeGuiasSimplesNacional);
